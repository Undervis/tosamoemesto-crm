...
let titleMapped = ref("Название раздела")
...
let excludePages = ["FoodEditor", "CategoryEditor", "AdditionEditor"];
</script>
...
<template>
  <section class="border-bottom" v-show="!excludePages.includes($route.name)">
    <div class="hstack gap-2 p-2 align-items-center flex-wrap">
      ...
      <button class="btn btn-outline-primary" @click="openEditor"><i class="bi bi-plus-lg me-2"></i>Добавить</button>
      <div class="btn-group">
